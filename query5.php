...
<body ng-app="">
  ...
  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <a href="query2.php">Revert Slice operation</a>
  ...
  <?php
    ...
    try {
      ...
      $brand = $_GET['brand'];
      require_once 'db_config.php';
      print "<h4><u>Slice on $brand brand:</u></h4>";
      $query1 = "SELECT s.city, d.quarter, sum(p.bill_amount) as area_earning 
                 FROM fact_reservation_bookings p, dim_store s, dim_time d, dim_car c 
                 WHERE c.car_key = p.car_key AND p.time_key = d.time_key AND c.brand = '$brand' 
                 GROUP By s.city, d.quarter";
