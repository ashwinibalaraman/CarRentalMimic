...
<body ng-app="">
  ...
  <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <h4><u> Dice operation on brand(Audi/BMW) and quarter(Q1/Q2): </u></h4>
  ...
  <?php
    ...
    try {
      ...
      require_once 'db_config.php';
      $query1 = "SELECT s.city, c.brand, d.quarter, sum(p.bill_amount) as area_earning 
                 FROM fact_reservation_bookings p, dim_store s, dim_time d, dim_car c 
                 WHERE c.car_key = p.car_key AND p.time_key = d.time_key AND (c.brand = 'BMW' OR c.brand = 'Audi') AND (d.quarter = 'Q1' OR d.quarter = 'Q2') 
                 GROUP By s.city, c.brand, d.quarter ";
